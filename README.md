...
[![Kural sayısı](https://img.shields.io/badge/kural-610-blue?style=flat)](RULES.md)
...
Aynı doğrulama çekirdeği (`gtfs_pipeline::validate_bytes`) beş şekilde çalışır — hepsi aynı 610 kuralı, aynı sonucu üretir:
...
│   ├── rules/      # Kural tanımları ve registry (610 kural, 38 grup)
