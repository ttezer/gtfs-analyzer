...
>
> Durum: **2026-08-11** · kural sayısı **595** (38 grup)
>
...
`P1d9a0191` artık **KANITLI** sayılır: `RCT_006`, birden fazla uygun kategoriye
sahip `fare_product_id` için default kategori sayısının tam olarak bir olmasını
denetler; hem hiç default olmamasını hem de birden fazla default olmasını raporlar.
`P79f202e6` aynı kuralın `fare_products.rider_category_id` üzerinden uygunluk
kümesini kuran tarafını kanıtlamaya devam eder.
