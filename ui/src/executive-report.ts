...
<body>
  ...
  <section class="page">
    <div class="section-head"><div><p class="eyebrow">05</p><h2>${e(copy.fileInventory)} · ${n(model.profile.files)}</h2><p class="muted">${e(copy.appendixIntro)}</p></div><div class="brand"><span class="brand-mark">GA</span>GTFS Analyzer</div></div>
