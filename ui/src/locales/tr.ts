const tr = {
  ui: {
    ...
    'export.card.html.desc'           : 'Etkileşimli rapor. Sonuçları tarayıcınızda görüntüleyebilir ve paylaşabilirsiniz.',
    ...
    'export.card.pdf.desc'            : 'Raporu yazdırmaya uygun PDF olarak oluşturur. Yazdırma veya arşivleme için idealdir.',
    ...
    'export.html.print_grouped'       : 'Yazdırma için her kural en fazla {examples} örnekle gösteriliyor ({rules} kural, toplam {total} bulgu). Tam liste CSV ve JSON çıktılarında yer alır.',
  ...
  ruleTitles: {
    ...
    'JPN_022': 'GTFS-JP v4: {file} içindeki {field} alanı {observed_value} kayıtta eksik veya boş.',
  } as Record<string, string>,
};
