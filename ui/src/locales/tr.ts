const tr = {
  ui: {
    ...
    'upload.error_size'       : 'Dosya çok büyük ({mb} MB). Maksimum izin verilen boyut: {max} MB.',
    ...
    'domain.gtfs_jp.coverage'    : 'GTFS-JP {profile} · %100 otomatik kapsama (insan yorumu ve yalnızca öneri hükümleri hariç)',
    'domain.gtfs_jp.coverage_tip': 'Profilin uyguladığı makineyle doğrulanabilen MLIT hükümlerinin tamamı kapsanır; insan yorumu, dış doğrulama ve yalnızca öneri niteliğindeki hükümler hariçtir. Feed’in resmî GTFS-JP sürümü otomatik olarak tespit edilmez.',
