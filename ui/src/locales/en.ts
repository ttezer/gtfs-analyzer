...
const en: LocaleShape = {
  ...
  ruleMessages: {
    ...
    'XFL_027': "Route '{entity_id}': the cEMV flag differs from Fares v2 information; Fares v2 takes precedence.",
    ...
    'XFL_019': "Network '{entity_id}' is defined in routes.network_id while networks.txt or route_networks.txt is also present.",
  ...
  ruleRemediations: {
    ...
    'STP_024': 'Use 0 or 1 for stop_access; 2 is not defined by GTFS.',
    'STP_026': 'Use 0 or 1 for stop_access.',
    ...
    'XFL_027': 'This is informational only: Fares v2 takes precedence over the cEMV flag.',
    ...
    'XFL_019': 'Define the network assignment in only one place: either routes.txt network_id or networks.txt/route_networks.txt.',
