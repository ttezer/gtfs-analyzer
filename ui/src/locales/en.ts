...
const en: LocaleShape = {
  ...
  ruleMessages: {
    ...
    'STM_036': "Trip '{entity_id}': stop_sequence is not monotonically increasing (found: {observed_value}, expected: {expected_value}).",
  ...
  ruleTitles: {
    ...
    'STM_036': 'stop_sequence values out of order (unsorted_stop_times)',
