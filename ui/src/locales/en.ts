...
const en: LocaleShape = {
  ...
  ruleMessages: {
    ...
    'JPN_016': "Route '{entity_id}': routes_jp.txt route_update_date is not a valid YYYYMMDD date.",
  ...
  ruleRemediations: {
    ...
    'JPN_016': 'Set route_update_date to a valid YYYYMMDD date.',
  ...
  ruleTitles: {
    ...
    'JPN_015': 'GTFS-JP: routes_jp route_id invalid',
    'JPN_016': 'GTFS-JP: route_update_date invalid',
