...
const en: LocaleShape = {
  ...
  ruleMessages: {
    ...
    'STP_021': "Stop '{entity_id}' is a child stop located outside its parent station.",
    ...
    'CAL_007': "Service '{entity_id}': {observed_value} gap in service period (threshold: {expected_value}).",
    ...
    'CAL_012': "Service '{entity_id}': no active dates in the near future.",
    'CAL_013': "Service '{entity_id}': service period expired (last active date: {observed_value}).",
    ...
    'OPR_007': "Trip '{entity_id}': stop '{dup_stop}' appears multiple times in stop_times.",
  ...
  ruleRemediations: {
    ...
    'CAL_012': 'Fill the service gap in the near future or note that the service is temporarily suspended.',
    ...
    'OPR_007': 'Remove duplicate stop_id entries unless this is a loop route.',
    ...
    'STM_025': 'Check stop_times.txt time values; the segment duration is very short.',
    ...
    'TRP_020': "Set trip_headsign to the final stop's (terminal) name or a destination that represents that direction.",
  ...
  ruleTitles: {
    ...
    'STP_021': 'Child stop outside parent station',
    ...
    'OPR_007': 'Repeated stop within trip',
