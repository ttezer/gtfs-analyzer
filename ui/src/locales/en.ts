...
const en: LocaleShape = {
  ...
  ruleMessages: {
    ...
    'STM_015': "Trip '{entity_id}': first stop is missing {field}.",
    'STM_016': "Trip '{entity_id}': last stop is missing {field}.",
    ...
    'STM_057': "Trip '{entity_id}': only one stop_times record for {field} '{observed_value}'; two are required for the same location.",
  ...
  ruleRemediations: {
    ...
    'STM_015': 'Enter both arrival_time and departure_time for the first stop_times row.',
    'STM_016': 'Enter both arrival_time and departure_time for the last stop_times row.',
    ...
    'STM_057': 'Add two stop_times records for the same location_group_id/location_id, one for the pickup end and one for the drop-off end.',
  ...
  ruleTitles: {
    ...
    'STM_015': 'First stop is missing a required time',
    'STM_016': 'Last stop is missing a required time',
    ...
    'STM_057': 'Only one stop_times record for a Flex location',
