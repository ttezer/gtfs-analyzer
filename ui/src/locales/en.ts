...
const en: LocaleShape = {
  ...
  ruleMessages: {
    ...
    'JPN_016': "Pattern '{entity_id}': pattern_jp.txt route_update_date is not a valid YYYYMMDD date.",
  ...
  ruleRemediations: {
    ...
    'JPN_016': 'Set pattern_jp.txt route_update_date to a valid YYYYMMDD date.',
  ...
  ruleTitles: {
    ...
    'JPN_016': 'GTFS-JP: pattern_jp route_update_date invalid',
