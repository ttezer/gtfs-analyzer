...
const en: LocaleShape = {
  ...
  ruleMessages: {
    ...
    'CAL_007': "Feed-wide service gap {entity_id}: {observed_value} days (threshold: {expected_value}); no service is active during this window.",
    ...
    'CAL_012': "Near-future feed-wide service gap {entity_id}: {observed_value} days; no service is active during this window.",
