...
const en: LocaleShape = {
  ui: {
    ...
    'domain.gtfs_jp.coverage'    : 'GTFS-JP {profile} · 100% automated coverage (human review rules excluded)',
    'domain.gtfs_jp.coverage_tip': 'Covers all machine-verifiable MLIT provisions; rules requiring human judgment or external verification are excluded. The feed’s official GTFS-JP version is not inferred automatically.',
