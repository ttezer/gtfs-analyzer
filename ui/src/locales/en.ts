...
const en: LocaleShape = {
  ui: {
    ...
    'domain.gtfs_jp.coverage'    : 'GTFS-JP {profile} · 100% automated coverage (human review and recommendation-only provisions excluded)',
    'domain.gtfs_jp.coverage_tip': 'Covers all machine-verifiable MLIT provisions enforced by the profile; rules requiring human judgment, external verification, or recommendation-only provisions are excluded. The feed’s official GTFS-JP version is not inferred automatically.',
