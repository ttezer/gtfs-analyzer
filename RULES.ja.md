...
| CLD_004 | calendar_datesのみのサービスにアクティブな日付なし | 高 | 相互運用 |
| CLD_005 | 日付が合理的な年の範囲外 | 致命的 | 仕様 |
