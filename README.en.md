...
`gtfs-sdk` exposes the v0.11.0 validation engine as a typed JavaScript/TypeScript API. The feed is validated with local WASM and never leaves the application:
