...
The project covers **97.2% of the measurable GTFS Specification requirements** and anchors all 300 atoms in the field inventory to at least one Spec rule. Of its **623 rules**, **426** produced at least one finding in the most recent full 4,343-feed catalog run. Every rule is listed in [`RULES.en.md`](RULES.en.md).
