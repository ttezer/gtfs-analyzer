...
- Rozet sabit ürün kataloğuna dayanır; feed'e ait `r1.coverage_complete` alanı
...
JPN kural kaydı 33 karttan oluşur ve ayrıntılı alan, sürüm, sınıf ve test
...
Kapsam değiştiğinde bu envanter, kural kartları, `PROVISION_TRIAGE.md` ve
`provision_evidence.tsv` birlikte güncellenir. Rust/native, WASM ve SDK aynı
