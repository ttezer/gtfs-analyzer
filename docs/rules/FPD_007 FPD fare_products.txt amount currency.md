# FPD_007 FPD fare_products.txt amount currency —  para biriminin ISO 4217 ondalık basamak sayısını taşımıyor
...
|---|---|---|
| **FPD_007 FPD fare_products.txt amount currency** | ondalık basamak sayısı yanlış | biçim |
...
| `EUR 0.9` · `EUR 8` · `HKD 6.7` | FPD_007 FPD fare_products.txt amount currency |
| `JPY 100.00` | FPD_007 FPD fare_products.txt amount currency (yen ondalık taşımamalı) |
| `HKD 0.0000` | FPD_007 FPD fare_products.txt amount currency (fazla basamak) |
| boş / `abc` | sessiz (`_002`) |
