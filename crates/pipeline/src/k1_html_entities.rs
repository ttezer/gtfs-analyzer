...
//!
//! Kaynak : https://html.spec.whatwg.org/entities.json
...
//!
//! HTML5'in adlandırılmış karakter referanslarının TAMAMI (2125 ad). `ARC_032` bir
...
/// Noktalı virgül OLMADAN da geçerli olan ESKİ adlar (106 ad) — `&copy` gibi.
