...
pub static RULES: &[RuleMeta] = &[
    ...
    r!("JPN_015", Yuksek, Interop, 1, &[], Some("route_id"), VI, Entity,
        "GTFS-JP: routes_jp.route_id eksik, tekrarlı veya routes.txt'te yok"),
    r!("JPN_016", Orta, Quality, 1, &[], Some("route_id"), VS, Entity,
        "GTFS-JP: routes_jp.route_update_date geçersiz"),
