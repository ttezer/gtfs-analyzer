...
[![Nombre de règles](https://img.shields.io/badge/r%C3%A8gles-618-blue?style=flat)](RULES.fr.md)
...
| **Nombre total de règles** | **178** | **618** |
...
│   ├── rules/      # Définition des règles et registre (618 règles, 38 groupes)
